    ...
    var $addCollectionButton = $('<a type="button" class="btn btn-warning" class="add_collection_link">Ajouter Stagiaire</a>');
    var $delCollectionButton = $('<a type="button" class="btn btn-danger" class="del_collection_link">Supprimer</a>');
